package com.github.zchu.archapp.user.widget;
...
import com.github.zchu.archapp.user.R;
...
public class MineRowView extends RelativeLayout {
    ...
    private void initAttributeSet(Context context, AttributeSet attrs) {
        ...
        if (iconResId != 0) {
            ...
            ((LayoutParams) tvTitle.getLayoutParams()).leftMargin = ((LayoutParams) ivIcon.getLayoutParams()).leftMargin;
        }
